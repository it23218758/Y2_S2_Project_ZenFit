...
const ShopItemsManagement = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    description: "",
    image: null,
    type: "Suggestion", // New field for type
  });
  ...
  const handleClose = () => {
    ...
    setFormData({
      ...
      description: "",
      image: null,
      type: "Suggestion", // Resetting type on close
    });
    setEditItemId(null);
  };
  ...
  const handleSubmit = async () => {
    const { name, category, quantityInStock, price, description, image, type } = formData;
    const errors = {};
    ...
    data.append("type", type); // Append type field to form data
  ...
  const handleEdit = (item) => {
    setFormData({
      ...
      image: null,
      type: item.type || "Suggestion", // Ensure the type is included during edit
    });
