      ...
      <div className="row mb-4 text-center">
        <div className="col-md-3">
          <div className="alert alert-primary">
            <strong>Inquiries:</strong> {categoryCounts.inquiries}
          </div>
        </div>
        <div className="col-md-3">
          <div className="alert alert-success">
            <strong>Suggestions:</strong> {categoryCounts.suggestions}
          </div>
        </div>
        <div className="col-md-3">
          <div className="alert alert-warning">
            <strong>Complaints:</strong> {categoryCounts.complaints}
          </div>
        </div>
        <div className="col-md-3">
          <div className="alert alert-secondary">
            <strong>Others:</strong> {categoryCounts.others}
          </div>
        </div>
      </div>
